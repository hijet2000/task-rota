...
export const GoogleIcon: React.FC<IconProps> = (props) => (
    <svg {...props} role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Google</title><path d="M12.48 10.92v3.28h7.84c-.24 1.84-.85 3.18-1.73 4.1-1.02 1.02-2.62 1.9-4.82 1.9-5.78 0-10.46-4.66-10.46-10.44s4.68-10.44 10.46-10.44c3.34 0 5.38 1.34 6.62 2.56l2.34-2.34C19.64 1.18 16.48 0 12.48 0 5.6 0 0 5.6 0 12.48s5.6 12.48 12.48 12.48c7.2 0 12.04-4.82 12.04-12.26 0-.8-.08-1.54-.22-2.3z"/></svg>
);
...
export const MicrosoftIcon: React.FC<IconProps> = (props) => (
    <svg {...props} role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Microsoft</title><path d="M11.4 24H0V12.6h11.4V24zM24 24H12.6V12.6H24V24zM11.4 11.4H0V0h11.4v11.4zm12.6 0H12.6V0H24v11.4z"/></svg>
);
...
// FIX: Corrected the invalid path data in SageIcon. The original data was not a valid SVG path string.
// SIMPLIFIED: Replaced complex path with a simpler <circle> element for better readability and to resolve potential parser issues.
export const SageIcon: React.FC<IconProps> = (props) => (
